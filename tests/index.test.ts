import { checkBingo } from "../src/index";
import { BingoCard, CalledNumbers } from "../src/types";

describe("", () => {
  it("should return true for the bingo card", async () => {
    ...
    const result = checkBingo(calledNumbers, bingoCard);

    expect(result).toEqual(true);
  });

  it("should return false for the bingo card", async () => {
    const calledNumbers: CalledNumbers = [
      7, 4, 9, 5, 11, 17, 23, 2, 0, 14, 21, 24, 10, 16, 13, 6, 15, 25, 12, 22,
      18, 20, 8, 19, 3, 26, 1,
    ];
  ...
  it("should return several results for the bingo cards", async () => {
    const calledNumbers: CalledNumbers = [
      7, 4, 9, 5, 11, 17, 23, 2, 0, 14, 21, 24, 10, 16, 13, 6, 15, 25, 12, 22,
      18, 20, 8, 19, 3, 26, 1,
    ];
